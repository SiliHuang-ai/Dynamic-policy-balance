...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        # self.model_dir = str(config["run_dir"] / 'models')
        ...
        self.buffer = SharedReplayBuffer(self.all_args,
                                        ...
                                        share_observation_space,
                                        self.envs.action_space[0])
        self.last_buffer = [copy.deepcopy(self.buffer.obs),
                            copy.deepcopy(self.buffer.rnn_states),
                            copy.deepcopy(self.buffer.masks),
                            copy.deepcopy(self.buffer.available_actions)]
    def run(self):
